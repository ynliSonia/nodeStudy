...
(function e(t, n, r) {
	function s(o, u) {
	...
	}, { "./p/home/index.js": 2 }], 2: [function (require, module, exports) {
		...
		var ItemList = React.createClass({ displayName: "ItemList",
			...
			render: function render() {
				...
				return React.createElement("div", null, React.createElement("h1", null, "我是首页"), React.createElement(Items, { data: this.state.data }));
			}
		});

		var contain = document.getElementById("main");
		React.render(React.createElement(ItemList, { url: "../src/p/home/items.json" }), contain);
	}, {}] }, {}, [1]);