	...
	function s(o, u) {
		...
		var ItemList = React.createClass({ displayName: "ItemList",
			...
			render: function render() {
				...
				return React.createElement("div", null, React.createElement("h1", null, "我是详情页面"), React.createElement(Items, { data: this.state.data }));
			}
		});

		var contain = document.getElementById("main");
		React.render(React.createElement(ItemList, { url: "../src/p/detail/items.json" }), contain);
	}, {}] }, {}, [1]);